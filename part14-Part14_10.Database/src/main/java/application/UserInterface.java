    ...
    public void start() throws SQLException {
        while (true) {
            ...
            if (command.equals("2")){
                ...
                String descriptionInput = this.scanner.nextLine();
               
                int id = this.database.list().size();
                this.database.add(new Todo(nameInput, descriptionInput, false));
            }
            
            if (command.equals("3")){
                System.out.println("Which todo should be marked as done (give the id)?");
                int idInput = Integer.valueOf(this.scanner.nextLine());
                
                this.database.markAsDone(idInput);
            }
